const {
    AfterAll, BeforeAll, Before, After,
} = require('cucumber');
...
Before((options, callback) => {
    ...
    console.log(`Running the Scenario: ${options.pickle.name}`);
...
Before({ tags: '@google' }, () => {
    // This hook will be executed before scenarios tagged with @google
    console.log('###################################################################');
    console.log('# Before scenarios tagged with @google');
    console.log('###################################################################');
});
